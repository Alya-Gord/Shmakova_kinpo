...
/*! Функция для поиска максимальной подматрицы, состоящей из одинаковых элементов
...
/*! Функция для вычисления количества подряд идущих одинаковых элементов в каждой строке, начиная с каждой позиции
* \param[in] matrix матрица, в которой происходит поиск
* \param[in] rows количество строк в матрице
* \param[in] cols количество столбцов в матрице
...
/*! Функция сканирования матрицы вниз для определения максимального прямоугольника, начинающегося в заданной позиции
* \param[in] matrix матрица, в которой происходит поиск
...
* \param[in|out] res ссылка на структуру с параметрами максимальной подматрицы
*/
...
/*! Функция обновления параметров максимальной найденной подматрицы
